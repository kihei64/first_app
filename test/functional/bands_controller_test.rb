...
class BandsControllerTest < ActionController::TestCase
  ...
  test "should create band" do
    assert_difference('Band.count') do
      post :create, band: { email: @band.email, genre: @band.genre, name: @band.name, notes: @band.notes, rating: @band.rating, website: @band.website }
    end
  ...
  test "should update band" do
    put :update, id: @band, band: { email: @band.email, genre: @band.genre, name: @band.name, notes: @band.notes, rating: @band.rating, website: @band.website }
    assert_redirected_to band_path(assigns(:band))
  end
